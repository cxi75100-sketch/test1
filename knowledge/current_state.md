...
- `CONFIRMED`：Git 仓库尚无任何 commit，当前项目文件全部显示为 untracked；在建立基线前没有可依赖的版本历史或恢复点（TASK-022）。
...
- `UNVERIFIED`：OnePlus PLC110 首页“第 2 周”文案未截屏确认——截屏时手机处于前台使用中，画面被其他 App 浮窗覆盖，该截图已立即删除。
